<div class="border">
    <div class="heading_callback">У Вас возникли вопросы?</div> 
    <div class="subheading_callback">Вы всегда сможете с нами связаться по телефону или отправить нам сообщение на почту.</div>
...
<!-- Custom Text type-->
            ...
            <?php } ?>
            <div class="form-group">
                <button type="submit" onclick="<?= $analytic_script ?>" class="btn btn-success"><?php echo $button_send; ?></button>
            </div>
        </form>
    </div>
</div>
