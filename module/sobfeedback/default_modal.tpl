    ...
    <div class="modal-content col-md-12">
      ...
      <div class="modal-body">
              ...
              <?php foreach ($fields as $field) { ?>
                ...
                <!-- product name type -->
              <?php if ($field['type'] == 'product_name'){ ?>
              <input id="sobtextProductName" type="text" class="hidden" name="field[<?= $field['id_field'] ?>][message]" value="">
              <script type="text/javascript">
                  $(window).load(function () {
                      $('#feedbackModal<?php echo $module_id; ?>').on('show.bs.modal', function (event) {
              ...
              <?php if(isset($field['setting']->diapason) && $field['setting']->diapason){ ?>
              <div class="form-group">
